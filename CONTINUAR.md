...
Implementado: especificación de plataforma personal, UI de revisión v0.4 con dashboard fijo de widgets y sidebar colapsable, DemoClient en memoria, HttpClient preparado, OpenAPI 3.1 con 28 operaciones, stub HTTP sin efectos, build autocontenido, CI y 21 tests JavaScript. Se conserva el prototipo Python/SQLite y CI pasa en 3.11/3.12.
