...
const schemas={
 ...
 KnowledgePatch:obj({title:str(120),content:{type:'string',minLength:1,maxLength:50000},expectedRevision:{type:'integer',minimum:1}}),
...
export const routes=[
 ...
 ['/knowledge/{id}','patch','patchKnowledge','Update canonical Markdown with optimistic revision control.','KnowledgePatch',true],
